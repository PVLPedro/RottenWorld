...
<nav class="flex items-center h-15 bg-bg-primary list-none *:flex-1 *:h-full">
    <li class="nav-link {{ request()->is('inicio') ? 'bg-bg-primary-hover' : '' }} flex items-center justify-center *:h-full *:w-full *:flex *:items-center *:justify-center *:gap-2 hover:bg-bg-primary-hover">
        <a href="/inicio">
    ...
    <li class="nav-link {{ request()->is('*ficha*') ? 'bg-bg-primary-hover' : '' }} flex items-center justify-center *:h-full *:w-full *:flex *:items-center *:justify-center *:gap-2 hover:bg-bg-primary-hover">
        <a href="/fichas">
